...
shinyUI(
  ...
  navbarPage(
    ...
    tabPanel(
      ...
      h3("Author: Farhan Choudhary - January, 2018"),
      ...
      p("Source code of this application is available at",
        a(href = "https://github.com/farhanchoudhary/DevelopingDataProducts",
          "https://github.com/farhanchoudhary/DevelopingDataProducts")
      )
